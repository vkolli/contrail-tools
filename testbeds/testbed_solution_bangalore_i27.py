...
env.roledefs = {
    'all': [host1, host2,  host4, host5, host6,host7 ,host16,host21,host22],
    'cfgm': [host1, host2, host4],
    'openstack': [host4, host5, host6],
    'webui': [host1, host2, host4],
    'control': [host1, host2, host4],
    'compute': [host7, host18,host21,host22],
    'collector': [host1, host2, host4],
    'database': [host1, host2, host4],
    'build': [host_build],
    'monitor': [host2],
}

env.hostnames = {
    'all': ['nodei27', 'nodei28', 'nodei32', 'nodei35', 'nodei36', 'nodei37', 'nodei6','nodei11','nodei12']
}
