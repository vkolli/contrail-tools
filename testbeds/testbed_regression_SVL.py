...
host13 ='root@10.87.66.153'
host19 ='root@10.87.66.154'


#kvm_host1 = 'root@10.87.66.144'
kvm_host1 = 'root@10.87.66.147'
...
env.hostnames = {
    'all': ['5b8s29-vm1','5b8s29-vm2','5b8s29-vm3','5b8s29-vm4','5b8s30-vm1','5b8s30-vm2','5b8s30-vm3','5b8s30-vm4','5b8s31-vm1','5b8s31-vm2','5b8s31-vm3','5b8s31-vm4', '5b8s33','5b8s35','5b8s36','5b8s37','5b8s38','5b8s39']
}
...
env.dpdk = {
    host16: { 'huge_pages' : '50', 'coremask' : '0xf'},
}
