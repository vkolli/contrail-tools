...
env.roledefs = {
    'all': [host1,host2,host3,host4,host5,host6,host8,host9,host10],
    'openstack': [host1,host2,host3],
    'contrail-controller': [host1,host2,host3],
    'contrail-compute': [host4,host5,host8,host9,host10],
    'contrail-lb' : [ host6 ],
    'tsn': [host4,host5],
...
#==================================================================================
control_data = {
    host1 : { 'ip': '172.16.90.1/24', 'gw' : '172.16.90.254', 'device':'p514p1' },
    host2 : { 'ip': '172.16.90.2/24', 'gw' : '172.16.90.254', 'device':'p514p1' },
    host3 : { 'ip': '172.16.90.3/24', 'gw' : '172.16.90.254', 'device':'p514p1' },
    host4 : { 'ip': '172.16.90.4/24', 'gw' : '172.16.90.254', 'device':'p514p1' },
    host5 : { 'ip': '172.16.90.5/24', 'gw' : '172.16.90.254', 'device':'p514p1' },
    host6 : { 'ip': '172.16.90.6/24', 'gw' : '172.16.90.254', 'device':'p514p1' },
    #host7 : { 'ip': '172.16.90.7/24', 'gw' : '172.16.90.254', 'device':'p514p1' },
    host8 : { 'ip': '172.16.90.8/24', 'gw' : '172.16.90.254', 'device':'p514p1' },
    host9 : { 'ip': '172.16.90.9/24', 'gw' : '172.16.90.254', 'device':'p514p1' },
    host10 : { 'ip': '172.16.90.10/24', 'gw' : '172.16.90.254', 'device':'p514p1' },
}

#OPTIONAL STATIC ROUTE CONFIGURATION  
#===================================  
static_route  = {
    host1 : [{ 'ip': '172.18.90.0', 'netmask' : '255.255.255.0', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '7.7.7.77', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '8.8.8.88', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '34.34.34.34', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '33.33.33.33', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '32.32.32.32', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '31.31.31.31', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' }],
    host2 : [{ 'ip': '172.18.90.0', 'netmask' : '255.255.255.0', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '7.7.7.77', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '8.8.8.88', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '34.34.34.34', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '33.33.33.33', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '32.32.32.32', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '31.31.31.31', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' }],  
    host3 : [{ 'ip': '172.18.90.0', 'netmask' : '255.255.255.0', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '7.7.7.77', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '8.8.8.88', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '34.34.34.34', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '33.33.33.33', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
    ...
    host4 : [{ 'ip': '172.18.90.0', 'netmask' : '255.255.255.0', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '7.7.7.77', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '8.8.8.88', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '34.34.34.34', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '33.33.33.33', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '32.32.32.32', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '31.31.31.31', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' }],
    host5 : [{ 'ip': '172.18.90.0', 'netmask' : '255.255.255.0', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '7.7.7.77', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '8.8.8.88', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '34.34.34.34', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '33.33.33.33', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '32.32.32.32', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '31.31.31.31', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' }],
    host6 : [{ 'ip': '172.18.90.0', 'netmask' : '255.255.255.0', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '7.7.7.77', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '8.8.8.88', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '34.34.34.34', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '33.33.33.33', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '32.32.32.32', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '31.31.31.31', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' }],
    #host7 : [{ 'ip': '172.18.90.0', 'netmask' : '255.255.255.0', 'gw':'172.16.90.254', 'intf': 'p514p1' },
    #         { 'ip': '7.7.7.77', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
    #         { 'ip': '8.8.8.88', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
    #         { 'ip': '34.34.34.34', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
    #         { 'ip': '33.33.33.33', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
    #         { 'ip': '32.32.32.32', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
    #         { 'ip': '31.31.31.31', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' }],
    host8 : [{ 'ip': '172.18.90.0', 'netmask' : '255.255.255.0', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '7.7.7.77', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '8.8.8.88', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '34.34.34.34', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '33.33.33.33', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '32.32.32.32', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '31.31.31.31', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' }],
    host9 : [{ 'ip': '172.18.90.0', 'netmask' : '255.255.255.0', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '7.7.7.77', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '8.8.8.88', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '34.34.34.34', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '33.33.33.33', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '32.32.32.32', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '31.31.31.31', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' }],
    host10 : [{ 'ip': '172.18.90.0', 'netmask' : '255.255.255.0', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '34.34.34.34', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '8.8.8.88', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '7.7.7.77', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
             { 'ip': '33.33.33.33', 'netmask' : '255.255.255.255', 'gw':'172.16.90.254', 'intf': 'p514p1' },
