...
storage_node_config = {
    ...
    host2 : { 'disks' : ['/dev/sdc', '/dev/sdd'],
         'ssd-disks': ['/dev/sde'],
         'local-disks' : ['/dev/sdf'],
         'nfs' : ['10.87.129.119:/localstore/ceph/multibackend_mount1', '10.87.129.119:/localstore/ceph/multibackend_mount2'],
         'journal' : ['/dev/sdb']
    },
...
ext_nfs_livem = True
ext_nfs_livem_mount = '10.87.129.173:/root/wql'
