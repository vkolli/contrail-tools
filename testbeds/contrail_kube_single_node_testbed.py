...
#do_parallel = True
#haproxy = True
env.log_scenario='5b6s10 Kubernets Sanity'

env.test = {
  'mail_to' : 'soumilk@juniper.net',
...
env.test_repo_dir='/root/soumilk/contrail-tools/contrail-test'
