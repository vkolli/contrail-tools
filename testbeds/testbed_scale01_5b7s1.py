...
#==================================================================================
control_data = {
    host1 : { 'ip': '172.17.90.1/24', 'device':'eth1' },
    host2 : { 'ip': '172.17.90.2/24', 'device':'eth1' },
    host3 : { 'ip': '172.17.90.3/24', 'device':'eth1' },
    host4 : { 'ip': '172.17.90.4/24', 'device':'eth1' },
    host5 : { 'ip': '172.17.90.5/24', 'device':'eth1' },
    host6 : { 'ip': '172.17.90.6/24', 'device':'eth1' },
    host7 : { 'ip': '172.17.90.7/24', 'device':'eth1' },
    host8 : { 'ip': '172.17.90.8/24', 'device':'eth1' },
    host9 : { 'ip': '172.17.90.9/24', 'device':'eth1' },
    host10 : { 'ip': '172.17.90.10/24', 'device':'eth1' },
    host11 : { 'ip': '172.17.90.11/24', 'device':'p514p1' },
    host12 : { 'ip': '172.17.90.12/24', 'device':'p514p1' },
    host13 : { 'ip': '172.17.90.13/24', 'device':'p514p1' },
    host14 : { 'ip': '172.17.90.14/24', 'device':'p514p1' },
    host15 : { 'ip': '172.17.90.15/24', 'device':'p514p1' },
    host16 : { 'ip': '172.17.90.16/24', 'device':'p514p1' },
    host17 : { 'ip': '172.17.90.17/24', 'device':'p514p1' },
    host18 : { 'ip': '172.17.90.18/24', 'device':'eth1' },
    host19 : { 'ip': '172.17.90.19/24', 'device':'eth1' },
    host20 : { 'ip': '172.17.90.20/24', 'device':'eth1' },
}
...
static_route  = {
    ...
    host19 : [{ 'ip': '172.18.90.0', 'netmask' : '255.255.255.0', 'gw':'172.17.90.254', 'intf': 'eth1' },
             ...
             { 'ip': '32.32.32.32', 'netmask' : '255.255.255.255', 'gw':'172.17.90.254', 'intf': 'eth1' },
             { 'ip': '31.31.31.31', 'netmask' : '255.255.255.255', 'gw':'172.17.90.254', 'intf': 'eth1' }],
    host20 : [{ 'ip': '172.18.90.0', 'netmask' : '255.255.255.0', 'gw':'172.17.90.254', 'intf': 'eth1' },
             { 'ip': '7.7.7.77', 'netmask' : '255.255.255.255', 'gw':'172.17.90.254', 'intf': 'eth1' },
             { 'ip': '8.8.8.88', 'netmask' : '255.255.255.255', 'gw':'172.17.90.254', 'intf': 'eth1' },
             { 'ip': '34.34.34.34', 'netmask' : '255.255.255.255', 'gw':'172.17.90.254', 'intf': 'eth1' },
             { 'ip': '33.33.33.33', 'netmask' : '255.255.255.255', 'gw':'172.17.90.254', 'intf': 'eth1' },
