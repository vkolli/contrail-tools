...
control_data = {
    ...
    host2 : { 'ip': '77.77.1.20/24', 'gw' : '77.77.1.254', 'device': 'p1p2' },
    host3 : { 'ip': '77.77.1.30/24', 'gw' : '77.77.1.254', 'device': 'p1p2' },
    host4 : { 'ip': '77.77.1.11/24', 'gw' : '77.77.1.254', 'device': 'p2p2' },
    host5 : { 'ip': '77.77.1.21/24', 'gw' : '77.77.1.254', 'device': 'bond0' },
#    host6 : { 'ip': '77.77.1.31/24', 'gw' : '77.77.1.254', 'device': 'p2p2' },
}
