...
env.ntp_server = 'cmbu-build01.juniper.net'
...
storage_node_config = {
    host2 : { 'disks' : ['/dev/sdc:Pool_0', '/dev/sdd:Pool_1'], 'ssd-disks' : ['/dev/sde:Pool_0','/dev/sdf:Pool_1'] , 'journal' : ['/dev/sdb'] },
    host3 : { 'disks' : ['/dev/sdc:Pool_0', '/dev/sdd:Pool_1'], 'ssd-disks' : ['/dev/sde:Pool_0','/dev/sdf:Pool_1'] , 'journal' : ['/dev/sdb'] },
    host4 : { 'disks' : ['/dev/sdc:Pool_0', '/dev/sdd:Pool_1'], 'ssd-disks' : ['/dev/sde:Pool_0','/dev/sdf:Pool_1'] , 'journal' : ['/dev/sdb']  },
}
