...
storage_data = {
   host1 : { 'ip':'192.16.101.1/24', 'gw':'192.16.101.1', 'device':'eth0' },
   host2 : { 'ip':'192.16.101.2/24', 'gw':'192.16.101.1', 'device':'eth0' },
   host3 : { 'ip':'192.16.101.3/24', 'gw':'192.16.101.1', 'device':'eth0' },
   host4 : { 'ip':'192.16.101.4/24', 'gw':'192.16.101.1', 'device':'eth0' },
   host5 : { 'ip':'192.16.101.5/24', 'gw':'192.16.101.1', 'device':'eth0' },
   host6 : { 'ip':'192.16.101.6/24', 'gw':'192.16.101.1', 'device':'eth0' },
   host7 : { 'ip':'192.16.101.7/24', 'gw':'192.16.101.1', 'device':'eth0' },
   host8 : { 'ip':'192.16.101.8/24', 'gw':'192.16.101.1', 'device':'eth0' },
   host9 : { 'ip':'192.16.101.9/24', 'gw':'192.16.101.1', 'device':'eth0' },
   host10 : { 'ip':'192.16.101.10/24', 'gw':'192.16.101.1', 'device':'eth0' },
   host11 : { 'ip':'192.16.101.11/24', 'gw':'192.16.101.1', 'device':'eth0' },
   host12 : { 'ip':'192.16.101.12/24', 'gw':'192.16.101.1', 'device':'eth0' },
