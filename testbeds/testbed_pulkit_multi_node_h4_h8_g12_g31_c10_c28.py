...
host2 = 'root@10.204.217.112'
host3 = 'root@10.204.217.52'
host4 = 'root@10.204.217.71'
host5 = 'root@10.204.216.67'
host6 = 'root@10.204.217.13'
...
env.hostnames = {
   # 'all': ['nodeh4', 'nodeh8', 'nodeg12', 'nodeg31', 'nodec28']
     'all': ['nodeh4', 'nodeh8', 'nodeg12', 'nodeg31', 'nodec10', 'nodec28']
}
...
control_data = {
    ...
    host2 : { 'ip': '77.77.1.11/24', 'gw' : '77.77.1.254', 'device': 'p2p2' ,'vlan': '135'},
    host3 : { 'ip': '77.77.2.10/24', 'gw' : '77.77.2.254', 'device': 'p1p2' },
    host4 : { 'ip': '77.77.2.11/24', 'gw' : '77.77.2.254', 'device': 'p1p2' ,'vlan': '136'},
    host5 : { 'ip': '77.77.3.10/24', 'gw' : '77.77.3.254', 'device': 'p1p2' },
    host6 : { 'ip': '77.77.3.11/24', 'gw' : '77.77.3.254', 'device': 'p1p2' ,'vlan': '137'},
}
...
static_route  = {
    ...
    host4 : [{ 'ip': '77.77.1.0', 'netmask' : '255.255.255.0', 'gw':'77.77.2.254', 'intf': 'p1p2' },
             { 'ip': '77.77.3.0', 'netmask' : '255.255.255.0', 'gw':'77.77.2.254', 'intf': 'p1p2' }],
    ...
    host6 : [{ 'ip': '77.77.1.0', 'netmask' : '255.255.255.0', 'gw':'77.77.3.254', 'intf': 'p1p2' },
             { 'ip': '77.77.2.0', 'netmask' : '255.255.255.0', 'gw':'77.77.3.254', 'intf': 'p1p2' }]
}
