...
#Data Interface
control_data = {
   host1 : { 'ip': '13.0.0.1/24', 'gw' : '13.0.0.1', 'device':'node1_data_interface' },
   host2 : { 'ip': '13.0.0.2/24', 'gw' : '13.0.0.1', 'device':'node2_data_interface' },
   host3 : { 'ip': '13.0.0.3/24', 'gw' : '13.0.0.1', 'device':'node3_data_interface' },
}
